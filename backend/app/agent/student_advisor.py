...
def get_llm():
    ...
    return ChatGroq(
        temperature=0.7, model_name="llama-3.1-70b-versatile", groq_api_key=api_key
    )
    ...
    def analyze_performance(self, state: StudentState) -> StudentState:
        ...
        try:
            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    SystemMessage(
                        content="""You are an educational performance analyst. 
            ...
            state["performance_analysis"] = (
                "Unable to analyze performance at this time."
            )
            return state
    ...
    def identify_weak_topics(self, state: StudentState) -> StudentState:
        ...
        try:
            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    SystemMessage(
                        content="""You are an educational diagnostician. 
    ...
    def generate_suggestions(self, state: StudentState) -> StudentState:
        ...
        try:
            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    SystemMessage(
                        content="""You are an expert educational advisor. 
    ...
    def create_motivation(self, state: StudentState) -> StudentState:
        ...
        try:
            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    SystemMessage(
                        content="""You are a motivational educational coach. 
            ...
            state["motivational_message"] = (
                "Keep up the great work! Every quiz is a step forward in your learning journey. 🚀"
            )
            return state
